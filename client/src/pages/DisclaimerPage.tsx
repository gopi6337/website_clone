      ...
      <main className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        <div className="prose prose-gray max-w-none space-y-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            for Grades 5–10, and (b) <strong>AI</strong>, an AI-powered Maths teacher for
            Grades 5–12. All learning content is created through a combination of AI and
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              and assessments are independently created by AI.
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-800 mb-3">2. How AI Lessons Are Created</h2>
            <p className="text-gray-700 leading-relaxed mb-3">
              The AI teaching content shown to students is produced through the following pipeline,
            ...
            <ol className="list-decimal pl-6 space-y-2 text-gray-700 leading-relaxed">
              ...
              <li><strong>AI generation.</strong> AI independently generates fresh teaching slides, explanations, worked examples and practice questions for each topic.</li>
              ...
              <li><strong>Human oversight.</strong> Our curriculum team oversees the approval workflow and may edit or remove any AI lesson at any time.</li>
              <li><strong>Ownership.</strong> Approved AI content is the original work of EduVerseJr, and EduVerseJr owns the copyright.</li>
              <li><strong>No copied source material.</strong> We do not use any third-party textbook chapter content, past examination paper, or proprietary test-prep material as source content for AI lessons.</li>
            </ol>
            <p className="text-gray-700 leading-relaxed mt-3 text-sm">
              The set of AI providers used to power AI may change over time as the underlying
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              Content is generated with the assistance of artificial intelligence (AI) and
            ...
            <p className="text-gray-700 leading-relaxed mt-2">
              ...
              outdated answers ("hallucinations"). AI is a teaching aid and is not a substitute
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              AI and EduVerseJr teachers are educators, not counsellors, doctors, lawyers or
              ...
              professional or local emergency services. AI may suggest helpful general
